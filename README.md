...
# Installing
First you need a userscript manager, like [Tampermonkey](https://www.tampermonkey.net), [Violentmonkey](https://violentmonkey.github.io) or [Greasemonkey](https://addons.mozilla.org/en-US/firefox/addon/greasemonkey/) (the former is preferred). Then, download [dist/script.user.js](https://github.com/LeoRiether/CodeforcesPP/raw/master/dist/script.user.js), a pop-up should appear prompting to install the userscript. If this doesn't happen, add the .js manually and you're set.
